...
const Contact = () => {
    ...
    let onsubmit=(data,e)=>{
        e.preventDefault()
        console.log(data);
        axios.post("https://apurva-aca11-default-rtdb.firebaseio.com/contactform.json",data)
        reset()
    }
            ...
            <div className="container-fluid bg-warning" >
                ...
                <div className="row justify-content-between">
                    <div className="col-md-5">
                        ...
                        <p> (+91) 9834559684</p>
                        <br />
                        <a href="https://github.com/apurvamahajan007/ApurvaResume" target="_blank" style={{color:'black'}}><AiFillGithub style={{fontSize:'35px'}} /></a> 
                        <br /><br />
                    </div>
                    <div className="col-md-6 shadow" >
                        <form className='p-3' action=""  onSubmit={handleSubmit(onsubmit)} data-aos="flip-down">
